        ...
        if post.post_number != 1 && post.user_id != -1 then
            ...
            if raw[0, 7].downcase == "@system" then
                if raw[8, 5] == "close" then
                    ...
                    text = "Hello @" + topic.user.username + ", please refer to this topic for posting your code sample. Thanks. https://forum.codewizardshq.com/t/how-to-post-code-samples/21423/1"
